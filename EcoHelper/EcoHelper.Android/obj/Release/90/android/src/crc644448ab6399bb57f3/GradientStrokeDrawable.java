...
/** @hide */
	...
	public GradientStrokeDrawable (int p0)
	{
		super (p0);
		if (getClass () == GradientStrokeDrawable.class)
			mono.android.TypeManager.Activate ("XamarinBackgroundKit.Android.Renderers.GradientStrokeDrawable, XamarinBackgroundKit.Android", "Android.Graphics.Color, Mono.Android", this, new java.lang.Object[] { p0 });
	}
